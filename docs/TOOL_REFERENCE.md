...
| `lib_get_vault_component` | readonly | live_only | Resolve ONE managed (Workspace/Vault) component by Design Item ID. |
...
| `lib_list_vault_libraries` | readonly | live_only | List every available library, file-based AND managed (Workspace). |
...
| `sch_place_vault_components` | silent | live_only | Place MANY MANAGED (Workspace/Vault) components in ONE call. |
